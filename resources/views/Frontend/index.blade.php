...
<head>
    ...
    <link rel="stylesheet" href="/Frontend/assets/css/tooplate-main.css">
...
<nav>
    <ul>
        <li><a href="#1"><img src="/Frontend/assets/images/icon-1.png" alt=""> <em>Anasayfa</em></a></li>
        <li><a href="#2"><img src="/Frontend/assets/images/icon-2.png" alt=""> <em>Hakkımda</em></a></li>
        <li><a href="#3"><img src="/Frontend/assets/images/icon-3.png" alt=""> <em>Çalışmalar</em></a></li>
        <li><a href="#4"><img src="/Frontend/assets/images/icon-4.png" alt=""> <em>İletişim</em></a></li>
    </ul>
</nav>
...
<div class="slides">
    <div class="slide" id="1">
        <div id="slider-wrapper">
                ...
                <ul>
                    <li class="active-img">
                        <div class="slide-caption">
                            <h6>Yeni Tasarım</h6>
                            <h2>Harika bir<br>Blog</h2>
                        </div>
                    </li>
                    <li>
                        <div class="slide-caption">
                            <h6>Sonkez</h6>
                            <h2>Öğrenmek İçin<br>Toplantı</h2>
                        </div>
                    </li>
                    <li>
                        <div class="slide-caption">
                            <h6>Yakında Yapacaklarımız</h6>
                            <h2>Özel<br>Cihazlar</h2>
                        </div>
                    </li>
                </ul>
            </div>
            <div id="thumbnail">
                <ul>
                    <li class="active"><img src="/Frontend/assets/images/thumb-01.jpg" alt="Earth" /></li>
                    <li><img src="/Frontend/assets/images/thumb-02.jpg" alt="Meeting" /></li>
                    <li><img src="/Frontend/assets/images/thumb-03.jpg" alt="Smart" /></li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="owl-carousel owl-theme">
                        <div class="col-md-12">
                            <div class="featured-item">
                                <a href=""><img src="/Frontend/assets/images/item-01.jpg" alt=""></a>
                        ...
                        <div class="col-md-12">
                            <div class="featured-item">
                                <a href=""><img src="/Frontend/assets/images/item-02.jpg" alt=""></a>
                                <div class="down-content">
                        ...
                        <div class="col-md-12">
                            <div class="featured-item">
                                <img src="/Frontend/assets/images/item-03.jpg" alt="">
                                <div class="down-content">
                        ...
                        <div class="col-md-12">
                            <div class="featured-item">
                                <img src="/Frontend/assets/images/item-04.jpg" alt="">
                                <div class="down-content">
                        ...
                        <div class="col-md-12">
                            <div class="featured-item">
                                <img src="/Frontend/assets/images/item-05.jpg" alt="">
                                <div class="down-content">
                        ...
                        <div class="col-md-12">
                            <div class="featured-item">
                                <img src="/Frontend/assets/images/item-06.jpg" alt="">
                                <div class="down-content">
                        ...
                        <div class="col-md-12">
                            <div class="featured-item">
                                <img src="/Frontend/assets/images/item-07.jpg" alt="">
                                <div class="down-content">
                                    <h4>Donec non sagittis</h4>
                                    <h6>$85.00</h6>
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="featured-item">
                                <img src="/Frontend/assets/images/item-08.jpg" alt="">
                                <div class="down-content">
                        ...
                        <div class="col-md-12">
                            <div class="featured-item">
                                <img src="/Frontend/assets/images/item-09.jpg" alt="">
                                <div class="down-content">
                        ...
                        <div class="col-md-12">
                            <div class="featured-item">
                                <img src="/Frontend/assets/images/item-10.jpg" alt="">
                                <div class="down-content">
                        ...
                        <div class="col-md-12">
                            <div class="featured-item">
                                <img src="/Frontend/assets/images/item-11.jpg" alt="">
                                <div class="down-content">
                        ...
                        <div class="col-md-12">
                            <div class="featured-item">
                                <img src="/Frontend/assets/images/item-12.jpg" alt="">
                                <div class="down-content">
            ...
            <div class="container-fluid">
                <form id="contact" action="" method="post">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <fieldset>
                                <input name="email" type="text" class="form-control" id="email" placeholder="Mail Adresiniz..." required="">
                            </fieldset>
                        </div>
                        <div class="col-md-12">
                            <fieldset>
                        ...
                        <div class="col-md-12">
                            <fieldset>
                                <button type="submit" id="form-submit" class="button">Şimdi Gönder</button>
                            </fieldset>
                        </div>
                </form>
            </div>
...
<script src="/Frontend/assets/js/accordations.js"></script>
